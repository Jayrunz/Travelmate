...
import com.jayrun.utils.RefreshTime;
...
public class AutoListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		footer = inflater.inflate(R.layout.pullup_to_load_footer, null);
		loadFull = (TextView) footer.findViewById(R.id.loadFull);
		noData = (TextView) footer.findViewById(R.id.noData);
		more = (TextView) footer.findViewById(R.id.more);
		loading = (ProgressBar) footer.findViewById(R.id.loading);

		header = inflater.inflate(R.layout.pulldown_to_refresh_header, null);
		...
		this.addHeaderView(header, noData, false);
		this.addFooterView(footer, noData, false);
	...
	public void onRefreshComplete() {
		String currentTime = RefreshTime.getCurrentTime();
